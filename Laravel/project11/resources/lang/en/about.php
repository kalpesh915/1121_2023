<?php
    return [
        "title" => "Welcome",
        "header" => "Welcome to world of PHP Laravel Localization Example",
        "moral"=> "Lying breaks trust — even if you’re telling the truth, no one believes a liar.",
        "data" => "Once, there was a boy who became bored when he watched over the village sheep grazing on the hillside. To entertain himself, he sang out, “Wolf! Wolf! The wolf is chasing the sheep!”
